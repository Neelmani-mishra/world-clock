...
nota=Label(root,text="Hour  minutes  second",font="time 10 bold")
...
nota1=Label(root,text="Hour  minutes  second",font="time 10 bold")
...
nota2=Label(root,text="Hour  minutes  second",font="time 10 bold")
...
nota3=Label(root,text="Hour  minutes  second",font="time 10 bold")
